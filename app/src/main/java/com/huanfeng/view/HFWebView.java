...
public class HFWebView extends WebView
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public HFWebView hfSetPosition(int x, int y) {
		hfSetX(x);
		hfSetY(y);
		return this;
	}

	public HFWebView hfSetX(int x) {
		int w = getWidth();
		setLeft(x);
		setRight(x + w);
		return this;
	...
	public HFWebView hfSetPosition(double x, double y) {
		hfSetPosition(getParentWidthPercent(x), getParentHeightPercent(y));
		return this;
	}

	public HFWebView hfSetX(double x) {
		hfSetX(getParentWidthPercent(x));
		return this;
	}

	public HFWebView hfSetY(double y) {
		hfSetY(getParentHeightPercent(y));
		return this;
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public HFWebView hfSetCenter(int x, int y) {
		hfSetCenterX(x);
		hfSetCenterY(y);
		return this;
	}

	public HFWebView hfSetCenterX(int x) {
		hfSetX(x - getWidth() / 2);
		return this;
	}

	public HFWebView hfSetCenterY(int y) {
		hfSetY(y - getHeight() / 2);
		return this;
	}

	public HFWebView hfSetCenter(double x, double y) {
		hfSetCenterX(x);
		hfSetCenterY(y);
		return this;
	}

	public HFWebView hfSetCenterX(double x) {
		hfSetCenterX(getParentWidthPercent(x));
		return this;
	}

	public HFWebView hfSetCenterY(double y) {
	...
	public HFWebView hfSetRight(int right) {
		int w = getWidth();
		setRight(right);
		setLeft(right - w);
		return this;
	...
	public HFWebView hfSetBottom(int bottom) {
		int h = getHeight();
		setBottom(bottom);
		setTop(bottom - h);
		return this;
	...
	public HFWebView hfSetRight(double right) {
		return hfSetRight(getParentWidthPercent(right));
	}

	public HFWebView hfSetBottom(double bottom) {
		return hfSetBottom(getParentHeightPercent(bottom));
	}

	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public HFWebView hfSetSize(int width, int height) {
		hfSetWidth(width);
		hfSetHeight(height);
		return this;
	}

	public HFWebView hfSetWidth(int width) {
		setRight(getLeft() + width);
		return this;
	}

	public HFWebView hfSetHeight(int height) {
		setBottom(getTop() + height);
		return this;
	}

	public HFWebView hfSetSize(double width, double height) {
		hfSetWidth(width);
		hfSetHeight(height);
		return this;
	}

	public HFWebView hfSetWidth(double width) {
		hfSetWidth(getParentWidthPercent(width));
		return this;
	}

	public HFWebView hfSetHeight(double height) {
		hfSetHeight(getParentHeightPercent(height));
		return this;
	}

	public HFWebView hfSetSizeKeepCenter(int width, int height) {
		hfSetWidthKeepCenter(width);
		hfSetHeightKeepCenter(height);
		return this;
	}

	public HFWebView hfSetWidthKeepCenter(int width) {
		int x = hfGetCenterX();
		setRight(getLeft() + width);
		hfSetCenterX(x);
		return this;
	...
	public HFWebView hfSetHeightKeepCenter(int height) {
		int y = hfGetCenterY();
		setBottom(getTop() + height);
		hfSetCenterY(y);
		return this;
	...
	public HFWebView hfSetSizeKeepCenter(double width, double height) {
		hfSetWidthKeepCenter(width);
		hfSetHeightKeepCenter(height);
		return this;
	}

	public HFWebView hfSetWidthKeepCenter(double width) {
		hfSetWidthKeepCenter(getParentWidthPercent(width));
		return this;
	}

	public HFWebView hfSetHeightKeepCenter(double height) {
		hfSetHeightKeepCenter(getParentHeightPercent(height));
		return this;
	}

	public HFWebView hfScaleSize(double scale) {
	...
	public HFWebView hfSetDesignSizeScale(int width, int height) {
	...
	public HFWebView hfSetDesignSizeScaleX(int width, int height) {
		float scale = (float) UITools.screenWidth / UITools.desiginWidth;
		hfSetSize((int) (width * scale), (int) (height * scale));
		return this;
	}

	public HFWebView hfSetDesignSizeScaleY(int width, int height) {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public HFWebView hfSetBackgroundColor(int color) {
		setBackgroundColor(color);
		return this;
	}

	public HFWebView hfSetTag(int tag) {
		setTag(tag);
		return this;
	}
	...
	public HFWebView hfSetFillet(int width) {
	...
	public HFWebView hfSetBorder(int cornerRadius, int color) {
		return hfSetBorder(0, cornerRadius, color);
	}

	public HFWebView hfSetBorder(int borderWidth, int cornerRadius, int color) {
		float[] outerRadii = new float[8];
		float[] innerRadii = new float[8];
		for (int i = 0; i < 8; i++) {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public HFWebView aid() {
		new HFAid(this);
		return this;
	}

	public HFWebView hfCopyPostionFrom(View view) {
		hfSetPosition(view.getLeft(), view.getTop());
		return this;
	}

	public HFWebView hfCopyCenterFrom(View view) {
		hfSetCenter(view.getLeft() + view.getWidth() / 2, view.getTop() + view.getHeight() / 2);
		return this;
	}

	public HFWebView hfCopySizeFrom(View view) {
		hfSetSize(view.getWidth(), view.getHeight());
		return this;
	}

	public HFWebView hfCopyFrameFrom(View view) {
