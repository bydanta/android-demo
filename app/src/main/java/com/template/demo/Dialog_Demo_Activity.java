...
public class Dialog_Demo_Activity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn1:
                new ActionSheetDialog(Dialog_Demo_Activity.this)
                        .builder()
            ...
            case R.id.btn3:
                new ActionSheetDialog(Dialog_Demo_Activity.this)
                        ...
                        .addSheetItem("条目一", ActionSheetDialog.SheetItemColor.Blue,
                                new ActionSheetDialog.OnSheetItemClickListener() {
                                    @Override
                                    public void onClick(int which) {
                                        Toast.makeText(Dialog_Demo_Activity.this,
                ...
                break;
            case R.id.btn4:
                new AlertDialog(Dialog_Demo_Activity.this).builder().setTitle("退出当前账号")
                ...
                break;
            case R.id.btn5:
                new AlertDialog(Dialog_Demo_Activity.this).builder()
